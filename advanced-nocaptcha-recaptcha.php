...
class C4WP
{
    ...
    private function __construct()
    {
        ...
        if ( is_plugin_active( 'advanced-nocaptcha-recaptcha/advanced-nocaptcha-and-invisible-captcha-pro.php' ) ) {
            deactivate_plugins( 'advanced-nocaptcha-recaptcha/advanced-nocaptcha-and-invisible-captcha-pro.php' );
            return;
        }
