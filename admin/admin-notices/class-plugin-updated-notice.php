		...
		if ( in_array( $screen->base, $pages_for_banner, true ) && $show_update_notice ) {
			...
			<div class="c4wp-plugin-update">
				<div class="c4wp-plugin-update-content">
					...
					<a href="https://melapress.com/wordpress-captcha/releases/?utm_source=plugin&utm_medium=banner&utm_campaign=c4wp" target="_blank" class="c4wp-cta-link"><?php esc_html_e( 'Read the release notes', 'advanced-nocaptcha-recaptcha' ); ?></a>
				</div>
