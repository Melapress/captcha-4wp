...
class C4WP_Settings {
	...
	function actions_filters() {
		...
		add_action( 'admin_notices', array( $this, 'c4wp_nocaptcha_70_plugin_notice' ) );
	...
	function c4wp_nocaptcha_70_plugin_notice() {
		...
		if ( $needed && current_user_can( 'manage_options' ) && ! get_user_meta( $user_id, 'c4wp_nocaptcha_plugin_notice_ignore' ) ) {
			// Add scripts.
